...
\begin{document}
    ...
    \title{Notes from CS 3790: Introduction to Cognitive Science}
    ...
    \parbox{\textwidth}{%
        ...
        \medskip
        These notes are based on the following textbook: \textit{MIND, An Introduction to Cognitive Science}, Paul Thagard, MIT Press, 2nd edition, 2005.\\
...
\section{Brief History of Cognitive Science}
